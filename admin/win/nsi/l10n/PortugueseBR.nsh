...
StrCpy $MUI_FINISHPAGE_SHOWREADME_TEXT_STRING "Exibir notas de lançamento"
...
StrCpy $PageReinstall_NEW_Field_1 "Uma versão mais antiga de ${APPLICATION_NAME} está instalado em seu sistema. É recomendado que você desinstale a versão atual antes de prosseguir. Selecione a operação que deseja executar e clique em Avançar para continuar."
...
StrCpy $SEC_APPLICATION_DETAILS "Instalando ${APPLICATION_NAME}."
StrCpy $OPTION_SECTION_SC_SHELL_EXT_SECTION "Integração com Windows Explorer"
StrCpy $OPTION_SECTION_SC_SHELL_EXT_DetailPrint "Instalação de Integração com Windows Explorer"
StrCpy $OPTION_SECTION_SC_START_MENU_SECTION "Atalho no menu Iniciar"
...
StrCpy $UNINSTALLER_FILE_Detail "Criando Desinstalador"
...
StrCpy $INIT_NO_QUICK_LAUNCH "Atalho de Inicialização Rápida (Indisponível)"
StrCpy $INIT_NO_DESKTOP "Atalho Desktop (substitui existente)"
